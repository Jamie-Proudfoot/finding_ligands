...
pred_target = "pEC50" #"pEC50" for LIT-PCBA
data_suffix = "data_full" #"data_full" for LIT-PCBA
w = 1  # batch size
m = 10  # initial pool size
M = 10_000 # budget, e.g. 10_000: arbitrarily high for target termination
EF_target = 4.0 + 1e-3 #for LIT-PCBA
percentile = None # percentile for enrichment factor calculation (leave as None: use EF_target)
dir = "results_litpcba/BRR_greedy"
